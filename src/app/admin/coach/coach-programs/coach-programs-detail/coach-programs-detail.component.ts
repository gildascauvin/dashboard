...
@Component({
  ...
  templateUrl: './coach-programs-detail.component.html',
  styleUrls: ['./coach-programs-detail.component.scss']
})
export class CoachProgramsDetailComponent implements OnInit {
  ...
  openProgramAthleteManagerModal() {
    const initialState = {
      programId: this.id,
      program: _.cloneDeep(this.model),
