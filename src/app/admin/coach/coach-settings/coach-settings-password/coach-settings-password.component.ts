...
@Component({
  selector: 'app-coach-settings-password',
  templateUrl: './coach-settings-password.component.html',
  styleUrls: ['./coach-settings-password.component.scss']
})
export class CoachSettingsPasswordComponent implements OnInit {
