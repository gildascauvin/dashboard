...
@Component({
  selector: 'app-coach-settings-language',
  templateUrl: './coach-settings-language.component.html',
  styleUrls: ['./coach-settings-language.component.scss']
})
export class CoachSettingsLanguageComponent implements OnInit {
