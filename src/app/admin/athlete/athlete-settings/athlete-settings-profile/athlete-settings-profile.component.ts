...
@Component({
  selector: 'app-athlete-settings-profile',
  templateUrl: './athlete-settings-profile.component.html',
  styleUrls: ['./athlete-settings-profile.component.scss']
})
export class AthleteSettingsProfileComponent implements OnInit {
	model: any = {};
	errors: any = {};
